...
public class VRkeySpawner : MonoBehaviour
{
    public GameObject[] keyClones;
    ...
    void SpawnObjects()
    {
        for (int i = 0; i < numberOfKeys; i++)
        {
            ...
            keyClones[i].transform.position = spawnLocations[selectedPosition].transform.position;
            keyClones[i].transform.rotation = spawnLocations[selectedPosition].transform.rotation;
        }
    }
